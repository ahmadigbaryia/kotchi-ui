...
export default function attribute(targetOrData, name, descriptor) {
...
function descriptorFn({ setter = defaultPropertySetter, getter = defaultPropertyGetter } = {}, target, propertyName, descriptor) {
    ...
    return {
        ...
        get() {
            ...
            return getter.call(this, { component: this, attribute, defaultValue });
        }
    }
}
/**
